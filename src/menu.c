...
static MenuItem menuitems[] = {
    {MENU_OP_MAXIMIZE,     "xfce-wm-maximize",   ("Ma_ximize")},
    {MENU_OP_UNMAXIMIZE,   "xfce-wm-unmaximize", ("Unma_ximize")},
    {MENU_OP_MINIMIZE,     "xfce-wm-minimize",   ("Mi_nimize")},
    {MENU_OP_MINIMIZE_ALL, NULL,                 ("Minimize _All Other Windows")},
    {MENU_OP_UNMINIMIZE,   NULL,                 ("S_how")},
    {MENU_OP_MOVE,         NULL,                 ("_Move")},
    {MENU_OP_RESIZE,       NULL,                 ("_Resize")},
    {0, NULL, NULL}, /* -------------------------------------------------------- */
    {MENU_OP_ABOVE,        NULL,                 ("Always on Top")},
    {MENU_OP_NORMAL,       NULL,                 ("Same as Other Windows")},
    {MENU_OP_BELOW,        NULL,                 ("Always Below Other Windows")},
    {MENU_OP_SHADE,        "xfce-wm-shade",      ("Roll Window Up")},
    {MENU_OP_UNSHADE,      "xfce-wm-unshade",    ("Roll Window Down")},
    {MENU_OP_FULLSCREEN,   "gtk-fullscreen",     ("_Fullscreen")},
    {MENU_OP_UNFULLSCREEN, "gtk-fullscreen",     ("Leave _Fullscreen")},
    {MENU_OP_CONTEXT_HELP, "gtk-help",           ("Context _Help")},
    {0, NULL, NULL}, /* -------------------------------------------------------- */
    {MENU_OP_STICK,        "xfce-wm-stick",      ("Always on Visible Workspace")},
    {MENU_OP_UNSTICK,      "xfce-wm-unstick",    ("Only on This Workspace")},
    {MENU_OP_WORKSPACES,   NULL,                 ("Move to Another Workspace")},
    {0, NULL, NULL}, /* -------------------------------------------------------- */
    {MENU_OP_DELETE,       "xfce-wm-close",      ("_Close")},
#if 0
    {0, NULL, NULL}, /* -------------------------------------------------------- */
    {MENU_OP_DESTROY,      "gtk-delete",         ("Destroy")},
    {0, NULL, NULL}, /* -------------------------------------------------------- */
#endif
    {MENU_OP_QUIT,         "gtk-quit",           ("_Quit")},
    {MENU_OP_RESTART,      "gtk-refresh",        ("Restart")},
};
...
/*        if (!GTK_MENU_SHELL (GTK_MENU (menu->menu))->have_xgrab)
        {
            gdk_beep ();
            g_message (("%s: GtkMenu failed to grab the pointer\n"), g_get_prgname ());
