...
myScreenInit (DisplayInfo *display_info, GdkScreen *gscr, unsigned long event_mask, gboolean replace_wm)
{
    ...
    screen_info->xroot = (Window) gdk_x11_window_get_xid(gdk_screen_get_root_window (gscr));
    ...
    screen_info->xfwm4_win = GDK_WINDOW_XID (gtk_widget_get_window(screen_info->gtk_win));
